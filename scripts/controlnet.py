...
class Script(scripts.Script):
    ...
    def process(self, p, is_img2img=False, is_ui=False, *args):
        ...
        for idx, contents in enumerate(control_groups):
            ...
            if pres > 64:
                detected_map, is_image = preprocessor(input_image, res=pres, thr_a=pthr_a, thr_b=pthr_b, enable_boost=enable_boost)
            else:
                detected_map, is_image = preprocessor(input_image, enable_boost=enable_boost)
